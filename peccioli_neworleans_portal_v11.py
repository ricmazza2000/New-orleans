...
if pagina == "Home":
    ...
    # Countdown funzionante via st.components
    import streamlit.components.v1 as components

    countdown_html = """
    <div style="display:flex;gap:1rem;margin-bottom:1.2rem;align-items:stretch;font-family:'Inter',sans-serif;">
        <div style="flex:1.4;background:linear-gradient(135deg,#0d1f3c,#17305a);border-radius:20px;padding:1.4rem 1.6rem;color:white;display:flex;flex-direction:column;justify-content:center;">
            <div style="font-size:0.7rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#d08c38;margin-bottom:0.5rem;">⏳ Mancano al viaggio</div>
            <div id="cd" style="font-size:2.4rem;font-weight:800;color:white;line-height:1.1;letter-spacing:-0.01em;">—</div>
        </div>
        <div style="flex:1;background:white;border-radius:20px;padding:1.2rem 1rem;text-align:center;border:1px solid rgba(20,33,61,0.08);box-shadow:0 6px 20px rgba(0,0,0,0.05);">
            <div style="font-size:2.2rem;font-weight:800;color:#d08c38;line-height:1;font-family:Georgia,serif;">21–28</div>
            <div style="font-size:0.8rem;color:#5b6472;margin-top:0.3rem;font-weight:500;">Settembre 2026</div>
        </div>
        <div style="flex:1;background:white;border-radius:20px;padding:1.2rem 1rem;text-align:center;border:1px solid rgba(20,33,61,0.08);box-shadow:0 6px 20px rgba(0,0,0,0.05);">
            <div style="font-size:2.2rem;font-weight:800;color:#d08c38;line-height:1;font-family:Georgia,serif;">80</div>
            <div style="font-size:0.8rem;color:#5b6472;margin-top:0.3rem;font-weight:500;">Giovani partecipanti</div>
        </div>
    </div>
    <script>
        ...
        if (el) {
            if (t <= 0) {
                ...
                el.innerHTML = d + "<span style='font-size:1.1rem;font-weight:400;opacity:0.65;margin-left:0.3rem;'>giorni</span>";
            }
        }
    </script>
    """
    ...
    for i, item in enumerate(valid_items):
        with cols[i]:
            ...
            if b64:
                st.markdown(f"""
                <div style="border:3px solid {border_color}; border-radius:12px; overflow:hidden; margin-bottom:0.3rem;">
