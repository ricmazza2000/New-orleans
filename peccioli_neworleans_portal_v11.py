...
<div class="info-viaggio-box">
    <div class="info-viaggio-eyebrow">📋 Tutto per il viaggio</div>
    <div class="info-viaggio-title">Informazioni per il viaggio</div>
    <div class="info-viaggio-sub">
        Voli, hotel, contatti dell'accompagnatore, documenti, valuta, clima, sicurezza. Tutto quello che serve sapere prima di partire — e cosa esplorare in viaggio e al ritorno.
    </div>
    ...
    <a class="info-viaggio-cta info-viaggio-cta-secondary" href="#approfondimenti">
        🎬 In viaggio e al ritorno
    </a>
...
for s in sguardi:
    ...
    if s.get("luoghi"):
        ...
        for n_luogo in s["luoghi"]:
            ...
            chips.append(
                f'<a class="sguardo-chip-luogo" href="#mappe">'
...
/* Mini-card luogo con foto — è un link <a> che zoomma sulla mappa */
.luogo-card {{
    display: flex;
    gap: 0.9rem;
    align-items: stretch;
...
.luogo-card:hover .luogo-nome {{
    text-decoration: underline;
    text-decoration-color: var(--card-color, {BRAND_BLUE});
...
for tema_nome, col, svg, emoji, desc_tema, anchor_id in ordine_temi:
    ...
    # Mini-card luoghi nella griglia (cliccabili → smooth scroll alla mappa)
...
<div class="section-body sec-documenti">
    <div style="background:white;border-left:4px solid {BRAND_YELLOW};border-radius:0 12px 12px 0;
        ...
        📋 Tutti i materiali sono disponibili qui sotto.
