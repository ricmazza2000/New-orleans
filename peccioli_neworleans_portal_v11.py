...
.timeline::before {
    ...
    bottom: 0;
    width: 3px;
    background: linear-gradient(180deg, #d08c38, #17305a);
    border-radius: 3px;
}
.tl-item {
    display: flex;
...
squadre = [
    {"titolo": "🏛 Sguardo Storico",
     ...
     "esperto": "Rif. Elia Morelli"},
    {"titolo": "🌐 Sguardo Politico",
     "focus": "Il porto, il Mississippi nell'economia globale, le relazioni internazionali.",
     "missione": "Raccontare come una città del Sud parli al mondo intero.",
     "esperto": "Rif. Anthony Gardner"},
    {"titolo": "⚖️ Sguardo Sociale",
     "focus": "Le contraddizioni: ricchezza e povertà, gentrificazione, questioni razziali.",
     "missione": "Osservare le due Americhe che convivono nello stesso isolato.",
     "esperto": "Rif. Francesco Costa"},
    {"titolo": "🎷 Sguardo Sonoro",
     "focus": "Jazz, Blues, Second Lines, musicisti di strada di Frenchmen Street.",
     "missione": "Catturare il rumore della città come linguaggio vivo.",
     "esperto": "Dimensione musicale e culturale"},
    {"titolo": "🌊 Sguardo Resiliente",
     ...
     "esperto": "Resilienza urbana e sociale"},
    {"titolo": "🍲 Sguardo Gastronomico",
     "focus": "Cucina Creole e Cajun, Gumbo, Beignets, i mercati locali.",
     "missione": "Spiegare la cultura attraverso il cibo come fusione di popoli.",
     "esperto": "Multiculturalità quotidiana"},
    {"titolo": "🕯 Sguardo Mistico",
     "focus": "Il Voodoo, i cimiteri monumentali, il Mardi Gras, il folklore.",
     "missione": "Indagare la parte invisibile di New Orleans, tra simboli e immaginario.",
     "esperto": "Tradizioni culturali e popolari"},
    {"titolo": "👁 Sguardo Umano",
     "focus": "I volti delle persone, l'accoglienza del Sud, le storie individuali.",
     "missione": "Incrociare lo sguardo dei locali e raccontare la città attraverso chi la vive.",
     "esperto": "Ponte tra comunità"},
]
...
luoghi_dati = [
    ...
    {"nome": "French Quarter", "lat": 29.9584, "lon": -90.0645,
     ...
     "colore": "#c0392b", "tema": "Identità e storia"},
...
if pagina == "Home":
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .cd-label {
        ...
        text-transform:uppercase; color:#d08c38; margin-bottom:0.3rem;
    }
    .cd-num {
    ...
    @media (max-width:600px) {
        ...
        .cd-main {
            min-width:190px; scroll-snap-align:start;
    ...
    .quick-btn-label {
        font-size:0.68rem; color:#d08c38; font-weight:700;
    ...
    .hb-sub {
        font-size:0.78rem;color:#9aa3b0;margin-bottom:0.7rem;
    }
    .news-link {
    ...
    .news-link-dot {
        width:6px;height:6px;border-radius:50%;flex-shrink:0;margin-right:0.5rem;
    }
    .news-link-text {
        font-size:0.8rem;font-weight:600;color:#14213d;
    }
    </style>
    ...
    with tab2:
        ...
        film = [
            {"titolo": "Un tram che si chiama Desiderio", "anno": "1951 · Elia Kazan",
             ...
             "link": "https://www.imdb.com/title/tt0044081/", "colore": "#d08c38"},
            {"titolo": "Intervista col vampiro", "anno": "1994 · Neil Jordan",
             ...
             "link": "https://www.imdb.com/title/tt0110632/", "colore": "#17305a"},
            {"titolo": "Il curioso caso di Benjamin Button", "anno": "2008 · David Fincher",
             ...
             "link": "https://www.imdb.com/title/tt0421715/", "colore": "#2e7d5e"},
            {"titolo": "Treme", "anno": "2010–2013 · HBO",
             ...
             "link": "https://www.imdb.com/title/tt1279972/", "colore": "#d4a017"},
            {"titolo": "Easy Rider", "anno": "1969 · Dennis Hopper",
             ...
             "link": "https://www.imdb.com/title/tt0064276/", "colore": "#7b3f00"},
        ]
    ...
    with tab3:
        ...
        docs = [
            {"titolo": "Katrina: Come Hell and High Water", "anno": "Netflix · 2025 · Spike Lee",
             ...
             "link": "https://www.netflix.com/title/81676595", "label": "Netflix →", "colore": "#c0392b"},
            {"titolo": "Hurricane Katrina: Race Against Time", "anno": "National Geographic · 2025",
             ...
             "link": "https://www.imdb.com/title/tt37458027/", "label": "IMDb →", "colore": "#17305a"},
            {"titolo": "When the Levees Broke", "anno": "HBO · 2006 · Spike Lee",
             ...
             "link": "https://www.imdb.com/title/tt0783105/", "label": "IMDb →", "colore": "#2e7d5e"},
        ]
