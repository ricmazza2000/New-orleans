...
def mostra_opera_ispira():
    ...
    <div style="margin-top:0.5rem;">
        ...
        <h2 style="font-family:'Playfair Display',Georgia,serif;font-weight:800;font-size:1.8rem;line-height:1.1;margin-bottom:0.3rem;color:{BRAND_BLUE};">Da quegli sguardi</h2>
        <div style="font-family:'Lobster Two',cursive;font-style:italic;font-size:1.2rem;color:{BRAND_BLUE};margin-bottom:1.3rem;opacity:0.7;">nasce il nome del progetto</div>
        <p style="font-size:0.98rem;line-height:1.7;color:#2a3140;margin-bottom:0.6rem;">
            ...
            <strong style="color:{BRAND_BLUE};">80 ragazzi che andranno a New Orleans con occhi attenti,
            e ne torneranno cambiati.</strong>
        </p>
        <div style="font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:1.1rem;line-height:1.5;color:{BRAND_BLUE};border-left:4px solid {BRAND_YELLOW};padding:0.5rem 0 0.5rem 1.2rem;margin-top:1.2rem;">
...
st.markdown(f"<div class='footer-box'>Peccioli Eyes to New Orleans · 2026 · Portale ragazzi</div>", unsafe_allow_html=True)            ratio = max_width / img.width
            new_size = (max_width, int(img.height * ratio))
            img = img.resize(new_size, PILImage.LANCZOS)
        buf = io.BytesIO()
        img.save(buf, format="JPEG", quality=quality, optimize=True)
