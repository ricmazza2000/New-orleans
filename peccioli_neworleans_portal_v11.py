    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    with st.expander("Scopri a cosa serve →"):
        ...
        <p style="font-size:0.95rem;color:#3a4a5c;line-height:1.75;">
            ...
            e gli <strong>approfondimenti</strong> — libri, film, documentari.
        </p>
        """, unsafe_allow_html=True)
...
# ----------------------------
    ...
    with tab1:
        ...
        libri = [
            {"titolo": "Una banda di idioti", "autore": "John Kennedy Toole", "anno": "1980 · Pulitzer", "desc": "Capolavoro ambientato nella New Orleans degli anni '60. Satira geniale e irresistibile — il modo più divertente per entrare nell'anima della città.", "link": "https://it.wikipedia.org/wiki/Una_banda_di_idioti", "colore": "#d08c38"},
            {"titolo": "Blues Highway", "autore": "Rob Siebert", "anno": "Reportage narrativo", "desc": "Viaggio da Chicago a New Orleans sulle tracce delle origini della musica americana: blues, jazz, gospel. Per capire il legame tra musica e territorio.", "link": "https://marcosymarcos.com/libri/gli-alianti/blues-highway/", "colore": "#17305a"},
            {"titolo": "The Moviegoer", "autore": "Walker Percy", "anno": "1961 · National Book Award", "desc": "Romanzo ambientato a New Orleans, vincitore del National Book Award. Racconta l'alienazione e la ricerca di senso di un giovane creolo nella città del Mardi Gras.", "link": "https://it.wikipedia.org/wiki/Walker_Percy", "colore": "#2e7d5e"},
            {"titolo": "Zeitoun", "autore": "Dave Eggers", "anno": "2009 · Non fiction", "desc": "La storia vera di un siriano-americano rimasto a New Orleans durante Katrina. Un racconto potente su resilienza, razzismo e fallimento istituzionale dopo la catastrofe.", "link": "https://it.wikipedia.org/wiki/Zeitoun_(libro)", "colore": "#7b3f00"},
        ]
...
# ----------------------------
    ...
    temi = [
        ...
        {"titolo": "Resilienza", "label": "KATRINA", "colore": "#17305a", "bg": "#f0f4fb", "sottotitolo": "Katrina, ricostruzione e cambiamento climatico", "domanda": "Come si ricostruisce una città dopo che l'acqua se la porta via?", "desc": "Il 2005 ha messo a nudo le fragilità strutturali della città: infrastrutture, disuguaglianze razziali, risposta istituzionale. Vent'anni dopo, la città è ancora in cammino. Il Lower Ninth Ward è il luogo dove questo tema si tocca con mano.", "luoghi": "Lower Ninth Ward · Argini del Mississippi · Lakeview", "svg": svg_resilienza},
        {"titolo": "Società", "label": "PEOPLE", "colore": "#2e7d5e", "bg": "#f0faf5", "sottotitolo": "Diversità culturale, questioni razziali, umanità", "domanda": "Cosa succede quando culture lontanissime vivono nello stesso isolato da tre secoli?", "desc": "New Orleans è una delle città più multiculturali e diseguali degli Stati Uniti. L'eredità della schiavitù, la comunità creola, le contraddizioni tra turismo e vita reale: osservare la città attraverso le persone che la abitano è il modo più onesto di capirla.", "luoghi": "Congo Square · Tremé · Garden District", "svg": svg_societa},
        {"titolo": "Identità e storia", "label": "NOLA", "colore": "#7b3f00", "bg": "#fdf6f0", "sottotitolo": "Radici coloniali, voodoo, Mardi Gras, French Quarter", "domanda": "Perché New Orleans non somiglia a nessun'altra città americana?", "desc": "Fondata dai francesi, ceduta agli spagnoli, acquistata dagli Stati Uniti. Questa stratificazione di culture — europea, africana, caraibica — ha prodotto un'identità unica: il French Quarter, il voodoo, il Mardi Gras, la cucina creola.", "luoghi": "French Quarter · St. Louis Cemetery · Jackson Square", "svg": svg_storia},
    ]
